...
const attendanceRoutes = async (fastify, options) => {
  ...
  fastify.post('/upload', {
    schema: {
      ...
      description: 'Process and save attendance data uploaded from the frontend application',
      body: {
        type: 'object',
          ...
          attendanceData: {
            ...
            items: {
              ...
              properties: {
                ...
                details: { type: 'array', description: 'Daily attendance details' },
                summary: {
                  type: 'object',
                  properties: {
                    Present: { type: 'string' },
  ...
  fastify.get('/employee/:employeeId', {
    schema: {
      ...
      querystring: {
        type: 'object',
        properties: {
          periodFrom: { type: 'string', format: 'date', description: 'Start date for filtering' },
          periodTo: { type: 'string', format: 'date', description: 'End date for filtering' }
        }
      },
      response: {
        200: {
  ...
  fastify.get('/summary/:employeeId', {
    schema: {
      tags: ['Attendance'],
