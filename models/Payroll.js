    ...
    payrunHistory: [
      {
        ...
        reportPeriodFrom: { type: String, default: "" }, // Link to attendance period
        reportPeriodTo: { type: String, default: "" }, // Link to attendance period
        payslipGenerated: { type: Boolean, default: false }, // Track if payslip was generated
        payslipSent: { type: Boolean, default: false }, // Track if payslip was sent
        payslipSentAt: { type: Date }, // When payslip was sent
        emailResponse: { type: String, default: "" }, // Store email sending response
      },
    ],
  },
  { timestamps: true }
